...
- **Estructura**: Un marco que permite a las empresas delinear las habilidades técnicas y no técnicas específicas requeridas para cada rol.
- **Transparencia**: Una perspectiva clara para los candidatos sobre cómo la empresa valora diversas habilidades y requisitos, ayudándolos a comprender mejor lo que se espera de ellos.
- **Apertura**: Un modelo de evaluación que fomenta que las empresas den retroalimentación constructiva a los candidatos, promoviendo la comunicación abierta a lo largo del proceso de contratación.
...
- **Competencia**: Este componente nos ayuda a identificar las habilidades y características esenciales para el rol. Incluye no solo habilidades técnicas, sino también habilidades interpersonales y factores culturales que aseguren que un candidato encaje bien con el equipo. Al definir claramente lo que buscamos, podemos alinear mejor nuestras necesidades con lo que cada candidato ofrece. Por ejemplo, para un desarrollador de software, una competencia fundamental podría ser "habilidades técnicas". Esto se puede desglosar en áreas específicas como el lenguaje de programación a evaluar, los marcos y bibliotecas relevantes, y las prácticas relacionadas con pruebas y calidad de código.
- **Criterio**: Este componente establece estándares específicos para evaluar cada habilidad, clarificando las expectativas. Por ejemplo, si la habilidad es "Lenguajes de programación", el criterio podría ser "Dominio de lenguajes de programación relevantes", con más detalle como "Capacidad para escribir código en Python limpio y eficiente". Esto podría evaluarse con una lista de verificación o tareas adaptadas para medir con precisión la pericia del candidato.
- **Peso**: Este componente asigna importancia relativa a cada competencia. No todas las competencias son igualmente críticas, por lo que al priorizar las más relevantes, aseguramos que nuestra evaluación refleje lo que realmente necesitamos para el rol. Cada peso se distribuye entre las competencias especificadas, indicando los aspectos que valoramos más.
...
- **Puntuación**: Una puntuación numérica entre 1 y 10, donde 1 es la puntuación más baja posible y 10 es la puntuación máxima. Se asigna a cada habilidad en función del desempeño del candidato de acuerdo con el criterio.
- **Puntuación Total**: La suma de todas las puntuaciones de cada candidato. La fórmula matemática para describir esto sería: Puntuación Total = `∑(P × W)`
...
La OHM es un proyecto de código abierto, y animamos a las empresas a adoptar y adaptar este marco a sus necesidades específicas.
También damos la bienvenida a contribuciones para mejorar y expandir la OHM para servir mejor al proceso de contratación.
...
- Ingresar puntuaciones y observaciones de los candidatos, y calcular puntuaciones totales.
- Compartir enlaces a matrices de contratación en las aplicaciones de empleo.
- Compartir los resultados de la evaluación de manera privada con los candidatos.
